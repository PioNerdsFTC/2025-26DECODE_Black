...
@Autonomous(name = "RaiserRedCloseNoGap",group = "Maple Grove Competition NoGap",preselectTeleOp = "RedOpPostCompetition")
public class RaiserRedCloseNoGap extends OpMode {
